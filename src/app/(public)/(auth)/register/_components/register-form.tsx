...
export function RegisterForm({ className }: React.ComponentProps<"div">) {
  ...
  async function onSubmit(values: FormValues) {
    ...
    if (typeof window !== "undefined" && "PasswordCredential" in window) {
      try {
        type PC = { new (data: { id: string; password: string; name: string }): Credential };
        const cred = new (window as unknown as { PasswordCredential: PC }).PasswordCredential({
          id: values.email,
          password: values.password,
          name: values.name,
        });
          ...
          >
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-5">
                ...
                <motion.div {...fadeUp(0.11)} className="flex flex-col gap-2">
                ...
                <motion.div {...fadeUp(0.17)} className="flex flex-col gap-2">
              ...
              {/* Sign in link */}
              <motion.p {...fadeUp(0.23)} className="text-center text-sm text-muted-foreground">
